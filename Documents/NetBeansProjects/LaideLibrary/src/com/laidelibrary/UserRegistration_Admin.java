...
public class UserRegistration_Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFirstName11.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        lblFirstName11.setForeground(new java.awt.Color(56, 72, 96));
        lblFirstName11.setText("Role:");

        cbRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Administrator", "Librarian", "User" }));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lblFirstName11, javax.swing.GroupLayout.Alignment.TRAILING))
                                .addGap(18, 18, 18)
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if (txtFirstName.getText().trim().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this,
                    ...
                    "Password Mismatch!",
                    JOptionPane.WARNING_MESSAGE);
        } else if (cbRole.getSelectedItem().toString().equals("Select")){
            JOptionPane.showMessageDialog(this,
                    "Please choose a Role!",
                    "Choose a Role!", JOptionPane.WARNING_MESSAGE);
        }
            else {
            // Create an array to hold the user's details
            String[] newUser = new String[12];
            ...
            boolean status = queryObject.insertUser_Admin(newUser);
